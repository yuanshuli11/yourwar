        ...
        <div class="row">
            ...
            <div class="col-xs-9">
             ...
             <div class="row">
                ...
                <div class="col-xs-3">
                    {{changeUnit($userInfo['has_one_city_resource']['gold_num'])}}           </div>
                <div class="col-xs-3">
                    ({{calSpeed($userInfo['has_one_city_resource']['gold_change'])}} )
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 homeleft">粮食：</div>        
                <div class="col-xs-3">
                    {{changeUnit($userInfo['has_one_city_resource']['food_num'])}}           </div>
                <div class="col-xs-3">
                    ({{calSpeed($userInfo['has_one_city_resource']['food_change'])}} )
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 homeleft">钢铁：</div> 
                <div class="col-xs-3">
                    {{changeUnit($userInfo['has_one_city_resource']['steel_num'])}}           </div>
                <div class="col-xs-3">
                    ({{calSpeed($userInfo['has_one_city_resource']['steel_change'])}} )
                </div>     
            </div>
            <div class="row">
                <div class="col-xs-2 homeleft">石油：</div>
                <div class="col-xs-3">
                    {{changeUnit($userInfo['has_one_city_resource']['oil_num'])}}           </div>
                <div class="col-xs-3">
                    ({{calSpeed($userInfo['has_one_city_resource']['oil_change'])}} )
                </div>         
            </div>          
            <div class="row">
                <div class="col-xs-2 homeleft">稀矿：</div>
                <div class="col-xs-3">
                    {{changeUnit($userInfo['has_one_city_resource']['rare_num'])}}           </div>
                <div class="col-xs-3">
                    ({{calSpeed($userInfo['has_one_city_resource']['rare_change'])}} )
                </div>          
            </div>  
            <div class="row">           
            <div class="col-xs-2 homeleft">税率：</div>
            <div class="col-xs-3">
                <span>{{$userInfo['has_one_main_city']['tax']}}%</span>                
            </div>
            <div class="col-xs-3">          
            ...
            <div class="col-xs-3">
                <span>{{$userInfo['has_one_main_city']['people_love']}}/100</span>
            </div>
            </div>  
            <div class="row">   
            <div class="col-xs-2 homeleft">民怨：</div>
            <div class="col-xs-3">
                <span>{{$userInfo['has_one_main_city']['people_hate']}}</span>          
            </div>
            <div class="col-xs-3">              
            ...
            <div class="col-xs-3">
                <span>{{changeUnit($userInfo['has_one_city_resource']['people_num'])}}/{{changeUnit($userInfo['has_one_city_resource']['busy_people'])}}</span> 
        ...
        <div class="row">
            <div class="col-xs-12 officer-content">
                ...
                <div class="officer-list">
                    @foreach($userInfo['has_many_officers'] as $key=>$item)
                        <div   v-show="officerPage=='{{ceil(($key+1)/6)}}'" class="row show-officer-item">
                            <div class="col-xs-8"><span class="officers-name">{{$item['name']}}</span><span  class="officers-power">({{$item['force']}},{{$item['service']}},{{$item['knowledge']}},{{$item['level']}})</span></div>
                            <div class="col-xs-2">
                                <a>查看</a>                     
                            </div>
                            <div class="col-xs-2">
                    ...
                    @endforeach
                    @if(count($userInfo['has_many_officers'])>7)
                        <div class="row">
...
<script type="text/javascript">
    var app = new Vue({
        ...
        data: {
            block: 'resouse',
            officerPage:1,
            officerMax:{{ceil(count($userInfo['has_many_officers'])/6)}}
        },
        methods: {
