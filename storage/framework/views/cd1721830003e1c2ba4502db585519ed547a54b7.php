...
<div class="show-add">
<form class="form-horizontal" method="POST" action="<?php echo e(asset('/sysadmin/object/add')); ?>">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        <label  class="col-xs-4 control-label">数量限制</label>
        <div class="col-xs-8">
          <input  class="form-control"  type="number" name="max_number"  value="0" required="required"  placeholder="不重复，最大建造数量 0表示不限制">
        </div>
    </div>
    <div class="form-group">
