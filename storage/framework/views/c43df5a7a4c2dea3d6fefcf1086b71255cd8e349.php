...
<script type="text/javascript">
    ...
    var app = new Vue({
        el: '.home-content',
        data: {  
            tech:<?php echo json_encode($tech); ?>,
            buildingPage:1,
            canBuild:0,
            userNowStatus:<?php echo json_encode($userNowStatus); ?>,
            buildingMax:<?php echo e(ceil(count($tech)/8)); ?>,
        ...
        methods: {
            ...
            realBuild:function(){
                ...
                if(this.canBuild==0&&CAN_SUBMIT){
                    ...
                    $.ajax({
                        url:"<?php echo e(asset('/api/build/v1/techBuild')); ?>",
                        method:"POST",
                        data:data,
            ...
            buildUp:function(tech){
                ...
                if(CAN_SUBMIT){
                    CAN_SUBMIT = false;
                    $.ajax({
                        url:"<?php echo e(asset('/api/build/v1/getTechUpInfo')); ?>",
                        method:"POST",
                        data:data,
                        success:function(result){
                            CAN_SUBMIT = true;
