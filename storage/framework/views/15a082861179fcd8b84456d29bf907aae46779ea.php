<div class="show-city">
        城市：<?php echo e($userInfo['has_one_main_city']['name']); ?>（<?php echo e($userInfo['has_one_main_city']['lng']); ?>,<?php echo e($userInfo['has_one_main_city']['lat']); ?>）<a>切</a>
</div>
<?php if(isset($partName)): ?>
<div class="part-name">
    <?php echo e($partName); ?>
